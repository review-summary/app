...
def form():
    ...
    if request.method == 'POST':
        ...
        # print(cluster_assignment_5_star)
        # print(corpus_1)
        # close_reviews_to_centroid = closest_points_to_cluster_centroid(cluster_assignment_1_star, corpus_1, centers_1, corpus_embeddings_1, m)
    ...
    return render_template('form.html', products=products, selected=selected, positive=list(set(pos)), negative=list(set(neg)))
